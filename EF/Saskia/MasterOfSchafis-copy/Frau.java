...
public class Frau
{
    ...
    public Frau(int groß, String name, int alter, String Spruch1, String Spruch2, String Spruch3 )//Konstruktor
    {
        Größe = groß;
        Name = name;
        Alter = alter;
    ...
    public void abchecken(Mann typ)
    {
        System.out.println('\u000c');
        
        if (typ.get_Größe()>Größe && typ.get_Aussehen()>=70)
        {
            System.out.println(Name+": OUH, den checke ich mal aus!");
            typ.abgecheckt(this);
        }
        else
        {
            System.out.println(Name+": Nee, der ist nichts für mich.");
        }
    }
    
    public void abgecheckt (Mann typ)
    {
        if (typ.get_Größe()<Größe && typ.get_Aussehen()>=70)
        {
            System.out.println(Name+": Hallo, Hübscher, öfters hier?");
            typ.flirt(this);
        }
        else
        {
    ...
    public char get_Beziehungsstatus()
    {
